 ...
 *     });
 */
Ext.define('Ext.spring.PickDateExt', {
    ...
    alias: 'widget.datepickerext',
    alternateClassName: 'Ext.DatePickerExt',
    ...
    initComponent : function() {
        ...
        //checked !
        me.checkedCls=me.baseCls + '-checked';
    ...
    selectedUpdate: function(date){
        ...
        for (c = 0; c < cLen; c++) {
            ...
            if (cell.dom.firstChild.dateValue == t) {
                ...
                if(cell.dom.className!='x-datepicker-active x-datepicker-checked'){
                	cell.addCls(cls);
                	
                	me.selDD.push(cell.dom.firstChild.dateValue);
                }else{
                	cell.removeCls(cls);                
                	Ext.Array.remove(me.selDD,cell.dom.firstChild.dateValue);
    ...
    fullUpdate: function(date){
        ...
        setCellClass = function(cell){
            ...
            //保留选择样式
            if(Ext.Array.contains( me.selDD,value)){
            	          
            	 cell.className += ' ' + me.checkedCls;
            }
